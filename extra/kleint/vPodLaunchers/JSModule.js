    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                console.log(1, message.ResourcesUrl, self.resourcesUrl);
...
;// CONCATENATED MODULE: ./src/vPodLaunchers/launchers/JSModule.ts
var JSModule_awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var JSModule_generator = (undefined && undefined.__generator) || function (thisArg, body) {
    var _ = { label: 0, sent: function() { if (t[0] & 1) throw t[1]; return t[1]; }, trys: [], ops: [] }, f, y, t, g;
    return g = { next: verb(0), "throw": verb(1), "return": verb(2) }, typeof Symbol === "function" && (g[Symbol.iterator] = function() { return this; }), g;
    function verb(n) { return function (v) { return step([n, v]); }; }
    function step(op) {
...
self.customExtractBody = function (body) { return JSModule_awaiter(void 0, void 0, void 0, function () {
    return JSModule_generator(this, function (_a) {
...
self.runVPod = function (url) { return JSModule_awaiter(void 0, void 0, void 0, function () {
    return JSModule_generator(this, function (_a) {
...
self.sendHttpRequest = function (message, virtualPodName, sessionId) { return JSModule_awaiter(void 0, void 0, void 0, function () {
